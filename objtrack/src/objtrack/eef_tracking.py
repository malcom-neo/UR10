...
class RobotManipulatorControl():
  def __init__(self):
    ...
    print(self.ur10.group.get_current_pose())
  ...
  def loadconfig(self):
    directory =  "/"+	str(os.path.dirname(os.path.abspath(__file__)).strip("src/objtrack")) + "/objtrack/config/markerposition.yaml" #disgusting
